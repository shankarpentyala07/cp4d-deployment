...
def tfPlan() {
    dir('managed-openshift/aws/terraform'){
            echo 'Terraform plan...'
            def ocs_map=['enable':"${params.ocs_storage_enable}",'ocs_instance_type':"${params.ocs_storage_instance_type}"]
